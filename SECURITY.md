...
NEXA 尚未发布稳定公开版本。当前只对最新维护中的候选版本进行安全修复；正式支持策略将在首个公开版本发布时确定。

## Reporting a vulnerability

请不要在公开 Issue、讨论区、日志或截图中粘贴 API Key、Token、Cookie、私钥、真实数据库、设备标识或其他个人数据。

公开仓库建立后，优先使用 GitHub Private Vulnerability Reporting 私下提交安全问题。该渠道尚未配置时，请等待项目所有者公布正式安全联系渠道；本项目当前没有可验证的专用安全邮箱，因此本文不会虚构邮箱地址。
